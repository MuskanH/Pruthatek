	...
	return (
		<>
			<div className={"bg-white dark:bg-[#101010]"}>
				...
				>
					<form onSubmit={showValues} onReset={showValues} className="space-y-6">
						...
						<div className="space-y-3">
							<p className="lg:text-[1.2vw] font-bold lg:mb-0 tracking-[1px]">Type of Blog</p>
						...
						<div className="space-y-3">
							<div><p className="lg:text-[1.2vw] font-bold lg:mb-0 tracking-[1px]">Section 1</p></div>
							<div className="relative">
								<input
									type="text"
									id="heading1"
									className="peer bg-transparent outline-none w-full border-b dark:border-white border-black loginInputs"
									autocomplete="off"
									value={heading1}
							...
							<div className="relative">
								<textarea
									...
									required
								/>
								<label className="absolute pointer-events-none left-0 top-5 tracking-[1px] transition-all duration-300" htmlFor='content1'>Content 1</label>
							</div>
							<div className="space-y-2">
								<h2 className="text-black dark:text-white py-2 tracking-[1px]">Image 1</h2>
								<div>
						...
						<div><p className="lg:text-[1.2vw] font-bold lg:mb-0 tracking-[1px]">Section 2</p></div>
						<div className="relative">
						...
						<div className="relative">
							<textarea
								...
								required
							/>
							<label className="absolute pointer-events-none left-0 top-5 tracking-[1px] transition-all duration-300 loginLabels" htmlFor='content2'>Content 2</label>
						</div>
						<div className="">
							<h2 className="text-black my-3 dark:text-white py-2 tracking-[1px]">Image 2</h2>
						...
						<div><p className="lg:text-[1.2vw] font-bold lg:mb-0 tracking-[1px]">Section 3</p></div>
						<div className="relative">
							<input
								type="text"
								id="heading3"
						...
						<div className="relative">
							<textarea
								...
								required
							/>
							<label className="absolute pointer-events-none left-0 top-5 tracking-[1px] transition-all duration-300 loginLabels" htmlFor='content3'>Content 3</label>
						</div>
						<div className="">
							<h2 className="text-black py-3 dark:text-white py-2 tracking-[1px]">Image 3</h2>
